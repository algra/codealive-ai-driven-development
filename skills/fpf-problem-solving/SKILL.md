...
| **Describe architecture or structural views** — characterise structure, produce adequate architectural descriptions and view types | 08 Part C → C.30 ADA, C.30.ASV Architecture Structural View; 07 Part B → A.22 STRUCT-CAL |
...
| 02 | [Table of Content](sections/02-table-of-content/_index.md) | 1 | Navigate the spec, locate a pattern, trace inter-section dependencies. |
...
| 11 | [E-I — Constitution](sections/11-section-e-i---the-fpf-constitution/_index.md) | 42 | **Govern and publish**: 11 Pillars, guard-rails, multi-view publication (MVPK), surface discipline, comparative reading, transduction graph, pattern quality gates, quality improvement loop, discoverability discipline. |
...
| 18 | [Part I — Annexes](sections/18-part-i-annexes-extended-tutorials/_index.md) | 1 | Walkthroughs, change log, external standards mappings. |
| 19 | [Part J — Indexes](sections/19-part-j-indexes-navigation-aids/_index.md) | 1 | Concept-to-pattern, pattern-to-example, principle-trace indexes. |
